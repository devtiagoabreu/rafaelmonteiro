...
export default function RegistrationModal({ isOpen, onClose, selectedProduct }: RegistrationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se for produto pago - redireciona para a página inicial que vai criar o pagamento
      else {
        console.log('💳 Produto pago - redirecionando para a página inicial')
        // Salva no localStorage que o usuário acabou de se cadastrar e quer comprar
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-actions">
              ...
              <button type="submit" className="btn-primary" disabled={isLoading}>
                {isLoading ? 'Processando...' : isFree ? '✅ Liberar Acesso Gratuito' : '💳 Confirmar e Comprar'}
              </button>
            </div>
          </form>
        </div>
