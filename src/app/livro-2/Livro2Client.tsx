//src/app/livro-2/Livro2Client.tsx
'use client'
...
import { chapters, bookInfo } from '@/data/livro-2'
import './livro-2.css'

export default function Livro2Client() {
  ...
  useEffect(() => {
    const savedBookmarks = localStorage.getItem('bookmarkedChapters-livro2')
    if (savedBookmarks) {
  ...
  useEffect(() => {
    localStorage.setItem('bookmarkedChapters-livro2', JSON.stringify(bookmarkedChapters))
  }, [bookmarkedChapters])
