...
export default function HomePage() {
  ...
  const handleFreeBookClick = () => {
    if (session) {
      // Se já estiver logado, vai direto para o livro
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      ...
      {/* HERO SECTION - LIVRO GRATUITO EM DESTAQUE */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition duration-500">
              {/* Placeholder para imagem do livro - substitua pela imagem real */}
              <div className="w-full h-full bg-gradient-to-br from-indigo-500 to-purple-700 flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-sm mt-4 opacity-75">* Imagem da capa do livro</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {/* Card 1 - PDF */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">📕</div>
              <h3 className="font-bold text-lg">Ebook (PDF)</h3>
              <p className="text-sm text-gray-600">Leia em qualquer dispositivo</p>
            </div>
            
            {/* Card 2 - Audiobook */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">🎧</div>
              <h3 className="font-bold text-lg">Audiobook</h3>
              <p className="text-sm text-gray-600">Ouça onde estiver</p>
            </div>
            
            {/* Card 3 - Podcast */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">🎙️</div>
              <h3 className="font-bold text-lg">Podcast</h3>
              <p className="text-sm text-gray-600">Episódios exclusivos</p>
            </div>
            
            {/* Card 4 - Videocast */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">📺</div>
              <h3 className="font-bold text-lg">Videocast</h3>
              <p className="text-sm text-gray-600">Conteúdo em vídeo</p>
            </div>
            
            {/* Card 5 - Resumo */}
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">📄</div>
              <h3 className="font-bold text-lg">Resumo (PDF)</h3>
              <p className="text-sm text-gray-600">Para revisão rápida</p>
            </div>
            
            {/* Card 6 - Infográfico */}
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">📊</div>
              <h3 className="font-bold text-lg">Infográfico</h3>
              <p className="text-sm text-gray-600">Mapas mentais</p>
            </div>
            
            {/* Card 7 - Apresentação */}
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">📽️</div>
              <h3 className="font-bold text-lg">Apresentação</h3>
              <p className="text-sm text-gray-600">Slides para estudo</p>
            </div>
            
            {/* Card 8 - Material Bônus */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl text-center shadow-lg hover:shadow-xl transition">
              <div className="text-5xl mb-3">🎁</div>
              <h3 className="font-bold text-lg">Bônus</h3>
              <p className="text-sm text-gray-600">Materiais extras</p>
            </div>
          </div>
